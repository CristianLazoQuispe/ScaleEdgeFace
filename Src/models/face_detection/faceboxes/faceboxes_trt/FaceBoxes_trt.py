...
class FaceDetector:
    def __init__(self, model_name="FaceBoxesProdTrt.pb", gpu_memory_fraction=0.25, visible_device_list='0',device='gpu'):
        """
        Arguments:
        ...
        if device == 'gpu':
            ...
            config_proto=tf.ConfigProto(log_device_placement=True,device_count={'CPU':1})
