...
from utils_faceboxes.functions import check_keys, remove_prefix, load_model
from utils_faceboxes.config import cfg
from models_faceboxes.faceboxes import FaceBoxesNet
...
def main():
    ...
    n = 10
    for i in range(n):
        dets,scores = face_boxes.predict(img)
