...
from models.faceboxes.faceboxes_trt import FaceBoxes_trt

model  = FaceBoxes_trt.FaceDetector("FaceBoxesProdTrt.pb",device='gpu',gpu_memory_fraction=0.1)
#model  = FaceBoxes_trt.FaceDetector("trt/trt_faceboxes_precision_FP16_segment_5_work_30.pb",device='gpu',gpu_memory_fraction=0.1)
#model  = FaceBoxes_trt.FaceDetector("trt/trt_faceboxes_precision_FP32_segment_50_work_20.pb",device='gpu',gpu_memory_fraction=0.1)

# SE DEDUCE QUE SEGMENT 50 ES MEJOR QUE SEGMENT 5 
